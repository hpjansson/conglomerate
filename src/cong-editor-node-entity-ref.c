...
struct _CongEditorNodeEntityRefDetails
{
	int dummy;
};
...
{
	CONG_EDITOR_NODE_CONNECT_HOOKS(entity_ref)
}
...
static void 
entity_ref_create_areas (CongEditorNode *editor_node,
...
CONG_EDITOR_NODE_DEFINE_BLOCK_AREA_REGENERATION_HOOK(entity_ref)
