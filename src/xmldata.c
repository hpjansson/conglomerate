...
/**
 * xml_add_required_content_choice
 * @cong_doc:
 * @content:
 * @node:
 * 
 ...
 * the user may type.
 *
 * Returns: whether a text node has been added
 */
static gboolean xml_add_optional_text_nodes(CongDocument *cong_doc, xmlElementContentPtr content, xmlNodePtr node) {
	xmlNodePtr new_node;
