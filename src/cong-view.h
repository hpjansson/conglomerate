...
struct CongViewClass
{
	...
	*/
	...
	void (*on_document_node_set_attribute)(CongView *view, gboolean before_change, CongNodePtr node, xmlNs *namespace, const xmlChar *name, const xmlChar *value);
	void (*on_document_node_remove_attribute)(CongView *view, gboolean before_change, CongNodePtr node, xmlNs *namespace, const xmlChar *name);
