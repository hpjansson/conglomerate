...
void
cong_cclosure_marshal_VOID__POINTER_POINTER (GClosure     *closure,
                                             GValue       *return_value,
                                             guint         n_param_values,
                                             const GValue *param_values,
                                             gpointer      invocation_hint,
...
/* VOID:POINTER,STRING (cong.marshal:12) */
void
...
/* VOID:POINTER,POINTER,STRING (cong.marshal:15) */
void
cong_cclosure_marshal_VOID__POINTER_POINTER_STRING (GClosure     *closure,
                                                    GValue       *return_value,
                                                    guint         n_param_values,
                                                    const GValue *param_values,
                                                    gpointer      invocation_hint,
...
/* VOID:POINTER,POINTER,STRING,STRING (cong.marshal:18) */
void
cong_cclosure_marshal_VOID__POINTER_POINTER_STRING_STRING (GClosure     *closure,
                                                           GValue       *return_value,
                                                           guint         n_param_values,
                                                           const GValue *param_values,
                                                           gpointer      invocation_hint,
                                                           gpointer      marshal_data)
{
  typedef void (*GMarshalFunc_VOID__POINTER_POINTER_STRING_STRING) (gpointer     data1,
                                                                    gpointer     arg_1,
                                                                    gpointer     arg_2,
                                                                    gpointer     arg_3,
                                                                    gpointer     arg_4,
                                                                    gpointer     data2);
  register GMarshalFunc_VOID__POINTER_POINTER_STRING_STRING callback;
  register GCClosure *cc = (GCClosure*) closure;
  register gpointer data1, data2;
  ...
  callback = (GMarshalFunc_VOID__POINTER_POINTER_STRING_STRING) (marshal_data ? marshal_data : cc->callback);
...
/* VOID:STRING,STRING,STRING (cong.marshal:20) */
void
